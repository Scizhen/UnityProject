...
{
	private CustomArrayDrawer<SuperSpline> splineArrayDrawer;
	...
	public void OnEnable( )
	{
		...
		splineArrayDrawer = new CustomArrayDrawer<SuperSpline>( this, OnInspectorChanged, bSpline, bSpline.splines, "Sub-Paths" ); 
	}

...
{
    //! Curve class within Simulation Path. Used to build the path system for AGV or MU. Posses catch points to support the construction of the path system.
    /// <summary>
    /// AGV路径中的弯曲线基本脚本
    /// </summary>
    ...
    [OnValueChanged("DrawPath")] public float Arrowsize;//!< Size of the curve mid arrow

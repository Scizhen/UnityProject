...
namespace RDTS.VisualScripting
{
    ...
    public class ValueInputBoolNode : Unit
    {
        ...
        private ValueInputBool _valueScript;
        ...
        protected override void Definition()
        {
            ...
            Set = ControlInput("SetValue", (flow) => {
                _valueScript = flow.GetValue<ValueInputBool>(valueObject);
            ...
            valueObject = ValueInput<ValueInputBool>("valueObject");

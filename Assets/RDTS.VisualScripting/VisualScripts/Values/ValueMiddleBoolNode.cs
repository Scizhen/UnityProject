...
namespace RDTS.VisualScripting
{
    ...
    public class ValueMiddleBoolNode : Unit
    {
        [DoNotSerialize]
        ...
        private ValueMiddleBool _valueScript;
        ...
        protected override void Definition()
        {
            ...
            Set = ControlInput("SetValue", (flow) => {
                _valueScript = flow.GetValue<ValueMiddleBool>(valueObject);
            ...
            valueObject = ValueInput<ValueMiddleBool>("valueObject");

...
public class GEN_FunctionTest8x8 : MonoBehaviour
{
    ...
    public void StartGENFunction(int expNum)
    {
        ...
        int[] drawdatatest = { 0, 3, 4, 6, 9, 11, 1, 2, 4, 8, 9, 14, 1, 2, 5, 8, 10, 14, 1, 2, 4, 7, 9, 14, 1, 2, 5, 8, 10, 14, 1, 2, 4, 8, 9, 13, 15, 19, 12, 21, 23, 15, 19, 11, 20, 23, 17, 18, 13, 21, 22, 16, 19, 11, 20, 23, 15, 18, 11, 21, 22, 0, 0, 3, 4, 7, 9, 6, 5, 2, 4, 5, 0, 4, 1, 10, 6, 7, 9, 5, 7, 10, 3, 0, 8, 1, 2, 2, 5, 4, 3, 8, 3, 1, 9, 8, 1, 0, 7, 9, 5, 6, 0, 10, 1, 2, 10, 4, 6, 4, 7, 6, 1, 3, 9, 5, 10, 8, 2, 8, 2, 3, 6, 0, 4, 5, 3, 2, 1, 2, 3, 0, 0, 6, 6, 7, 0, 2, 7, 4, 0, 5, 3, 0, 4, 2, 1, 2, 6, 1, 7, 0, 3, 4, 6, 5, 7, 4, 2, 3, 4, 5, 1, 3, 0, 2, 4, 4, 1, 2, 7, 6, 4, 7, 0, 0, 2, 5, 3, 1, 3, 1, 4 };
        drawdatatest[122] = 1;
        drawdatatest[121] = 1;
